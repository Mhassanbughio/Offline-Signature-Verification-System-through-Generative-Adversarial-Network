...
Original file is located at
    https://colab.research.google.com/drive/1NxDS3bUepaYyoIZtP3b38P_vHQMCiRbI
...
# Define the Google Drive file ID and the destination directory
file_id = "1bwDZjfOZzrh7oIoAmJPP9Nq5XrtPAwsj"
download_dir = "drive/MyDrive"
file_name = "70-30 split.zip"  # Change the filename if needed
download_path = os.path.join(download_dir, file_name)

# Define the URL to download from Google Drive
...
# Extract the ZIP file using the zipfile library
